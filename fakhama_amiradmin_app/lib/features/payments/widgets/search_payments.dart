...
class SearchPayments extends GetView<PaymentController> {
    ...
    return Column(
      children: [
        CustomTextField(
          ...
          hintText: "البحث في الدفعات (رقم الطلب، اسم العميل، المبلغ...)",
        ...
        Row(
          children: [
            ...
            Expanded(
              child: Obx(() {
                return DropDown<String>(
                  list: controller.uniquePaymentMethods,
                  title: "طريقة الدفع",
                  padding:
                      EdgeInsets.symmetric(horizontal: 20.w, vertical: 8.h),
                  radius: 5.r,
                  model: controller.selectedPaymentMethod.value,
                  onChange: controller.setPaymentMethod,
                );
              }),
            ),
            SizedBox(width: 10.w),
