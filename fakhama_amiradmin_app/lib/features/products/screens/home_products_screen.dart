...
import 'package:fakhama_amiradmin_app/features/products/widgets/list_products.dart';
import 'package:fakhama_amiradmin_app/features/products/widgets/search_products.dart';
...
class HomeProductsScreen extends GetView<ProductController> {
            ...
            child: Obx(
              () {
                ...
                if (controller.filteredProducts.isEmpty &&
                  ...
                  return RefreshEmptyWidget(
                    onRefresh: controller.fetchData,
                    emptyText: "no_products_found".tr,
                    value: "start_adding_first_products".tr,
    ...
    return Obx(() {
      ...
      return Container(
        ...
        child: Row(
          ...
          children: [
            Text(
              'عرض ${controller.products.length} من ${controller.totalItems.value}',
              style: TextStyle(
                fontSize: 12.sp,
